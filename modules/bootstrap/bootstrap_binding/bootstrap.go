...
func (_Bootstrap *BootstrapFilterer) FilterDelegateResult(opts *bind.FilterOpts, success []bool, delegator []common.Address, delegatee []string) (*BootstrapDelegateResultIterator, error) {
	...
	logs, sub, err := _Bootstrap.contract.FilterLogs(opts, "DelegateResult", successRule, delegatorRule, delegateeRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event DelegateResult(bool indexed success, address indexed delegator, string indexed delegatee, address token, uint256 amount)
func (_Bootstrap *BootstrapFilterer) WatchDelegateResult(opts *bind.WatchOpts, sink chan<- *BootstrapDelegateResult, success []bool, delegator []common.Address, delegatee []string) (event.Subscription, error) {
	...
	logs, sub, err := _Bootstrap.contract.WatchLogs(opts, "DelegateResult", successRule, delegatorRule, delegateeRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_Bootstrap *BootstrapFilterer) FilterUndelegateResult(opts *bind.FilterOpts, success []bool, undelegator []common.Address, undelegatee []string) (*BootstrapUndelegateResultIterator, error) {
	...
	logs, sub, err := _Bootstrap.contract.FilterLogs(opts, "UndelegateResult", successRule, undelegatorRule, undelegateeRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event UndelegateResult(bool indexed success, address indexed undelegator, string indexed undelegatee, address token, uint256 amount)
func (_Bootstrap *BootstrapFilterer) WatchUndelegateResult(opts *bind.WatchOpts, sink chan<- *BootstrapUndelegateResult, success []bool, undelegator []common.Address, undelegatee []string) (event.Subscription, error) {
	...
	logs, sub, err := _Bootstrap.contract.WatchLogs(opts, "UndelegateResult", successRule, undelegatorRule, undelegateeRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// FilterValidatorCommissionUpdated is a free log retrieval operation binding the contract event 0xf10609810855f458c633893e4ec8e85954f555afce4ddfe4367efd951cdc5817.
//
// Solidity: event ValidatorCommissionUpdated(uint256 newRate)
...
// WatchValidatorCommissionUpdated is a free log subscription operation binding the contract event 0xf10609810855f458c633893e4ec8e85954f555afce4ddfe4367efd951cdc5817.
//
// Solidity: event ValidatorCommissionUpdated(uint256 newRate)
...
// ParseValidatorCommissionUpdated is a log parse operation binding the contract event 0xf10609810855f458c633893e4ec8e85954f555afce4ddfe4367efd951cdc5817.
//
// Solidity: event ValidatorCommissionUpdated(uint256 newRate)
